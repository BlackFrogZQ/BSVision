...
namespace TIGER_UIBasic
{
    ...
    {
        return BS_QT_Ui::CCustomMessageBox::warning(parent, title, text, QMessageBox::Ok, QMessageBox::StandardButton::NoButton);
    }

    int questionBox(QWidget *parent, const QString &title, const QString &text)
    {
        return BS_QT_Ui::CCustomMessageBox::question(parent, title, text);
    }
